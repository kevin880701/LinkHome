...
GetMemberDevicesResponse _$GetMemberDevicesResponseFromJson(
    Map<String, dynamic> json) {
  return _GetMemberDevicesResponse.fromJson(json);
}

/// @nodoc
mixin _$GetMemberDevicesResponse {
  ...
  @JsonKey(ignore: true)
  $GetMemberDevicesResponseCopyWith<GetMemberDevicesResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetMemberDevicesResponseCopyWith<$Res> {
  factory $GetMemberDevicesResponseCopyWith(GetMemberDevicesResponse value,
          $Res Function(GetMemberDevicesResponse) then) =
      _$GetMemberDevicesResponseCopyWithImpl<$Res, GetMemberDevicesResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GetMemberDevicesResponseCopyWithImpl<$Res,
        $Val extends GetMemberDevicesResponse>
    implements $GetMemberDevicesResponseCopyWith<$Res> {
  _$GetMemberDevicesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetMemberDevicesResponseImplCopyWith<$Res>
    implements $GetMemberDevicesResponseCopyWith<$Res> {
  factory _$$GetMemberDevicesResponseImplCopyWith(
          _$GetMemberDevicesResponseImpl value,
          $Res Function(_$GetMemberDevicesResponseImpl) then) =
      __$$GetMemberDevicesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'device_id') int deviceId,
...
/// @nodoc
class __$$GetMemberDevicesResponseImplCopyWithImpl<$Res>
    extends _$GetMemberDevicesResponseCopyWithImpl<$Res,
        _$GetMemberDevicesResponseImpl>
    implements _$$GetMemberDevicesResponseImplCopyWith<$Res> {
  __$$GetMemberDevicesResponseImplCopyWithImpl(
      _$GetMemberDevicesResponseImpl _value,
      $Res Function(_$GetMemberDevicesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetMemberDevicesResponseImpl(
      deviceId: null == deviceId
          ? _value.deviceId
          : deviceId // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$GetMemberDevicesResponseImpl implements _GetMemberDevicesResponse {
  const _$GetMemberDevicesResponseImpl(
  ...
  factory _$GetMemberDevicesResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetMemberDevicesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetMemberDevicesResponse(deviceId: $deviceId, mac: $mac, type: $type, name: $name, placeId: $placeId, placeName: $placeName, areaId: $areaId, areaName: $areaName, modelId: $modelId, modelName: $modelName, modelImageUrl: $modelImageUrl, online: $online, power: $power, error: $error, installationDate: $installationDate)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetMemberDevicesResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetMemberDevicesResponseImplCopyWith<_$GetMemberDevicesResponseImpl>
      get copyWith => __$$GetMemberDevicesResponseImplCopyWithImpl<
          _$GetMemberDevicesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetMemberDevicesResponseImplToJson(
      this,
    );
  }
}

abstract class _GetMemberDevicesResponse implements GetMemberDevicesResponse {
  const factory _GetMemberDevicesResponse(
  ...
  factory _GetMemberDevicesResponse.fromJson(Map<String, dynamic> json) =
      _$GetMemberDevicesResponseImpl.fromJson;
