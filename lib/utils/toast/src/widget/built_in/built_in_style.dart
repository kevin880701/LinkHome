...
abstract class BuiltInStyle {
  ...
  IconData icon(BuildContext context) {
    return switch (type) {
      ToastificationType.success => Iconsax.tick_circle,
      ToastificationType.info => Iconsax.info_circle,
      ToastificationType.warning => Iconsax.danger,
      ToastificationType.error => Iconsax.close_circle,
    };
  }
